...
| 9 | [Исследование рынка общественного питания](https://github.com/egormusalimov/Yandex-Practicum/tree/main/food_market) | Исследование рынка на основе открытых данных о заведениях общественного питания Москвы | `Python` `Pandas` `Matplotlib` `Seaborn` `Plotly` `визуализация данных` |
| 10 | [Дашборд для Яндекс.Дзена](https://public.tableau.com/app/profile/egor.musalimov/viz/Dashproject/Dashboard1?publish=yes) |Разрабатываем и презентуем дашборд для анализа пользовательского взаимодействия в сервисе Яндекс.Дзен (Tableau Public) | `Python` `PostgreSQL` `Tableau` `продуктовые метрики` `построение дашбордов` `визуализация данных` |
| 11 | [Выпускной проект.](https://github.com/egormusalimov/Yandex-Practicum/tree/main/graduation) [Банки — cегментация пользователей по потреблению продуктов](https://github.com/egormusalimov/Yandex-Practicum/blob/main/graduation/banks_final.ipynb) , [Презентация](https://disk.yandex.ru/i/VBdeynGKRSCqiQ) и [Дашборд]( https://public.tableau.com/app/profile/egor.musalimov/viz/Metan_project/Dashboard1?publish=yes); [А/B тестирование](https://github.com/egormusalimov/Yandex-Practicum/blob/main/graduation/a_b_final.ipynb), [SQL](https://github.com/egormusalimov/Yandex-Practicum/blob/main/graduation/sql_final.ipynb)|Анализируем заемщиков банка (результат оформляем в виде Презентации), проверяем результаты А/B тестирования и подтверждаем гипотезы, разрабатываем дашборд в Tableau Public. изучаем мобильное приложение посредством SQL-запросов. | `Python` `PostgreSQL` `Pandas` `Matplotlib` `Seaborn` `Plotly` `визуализация данных` `Tableau` `продуктовые метрики` `построение дашбордов` `A/B-тестирование` |
